...
//DID You Know
var didYouKnow = [
  "<div class ='box'>the most commonly used letter in the alphabet is E.</div>","<div class = 'box'>cats spend 66%  of their life asleep.</div>",
  ...
  "<div class='box'>the smallest bones in the human body are found in your ear</div>","<div class='box'>each time you see a full moon you always see the same side</div>",
  "<div class='box'>the sentence 'the quick brown fox jumps over the lazy dog' uses every letter in the English alphabet</div>","<div class='box'>if you add up all the numbers from 1 to 100 consecutively (1 + 2 + 3...) it totals 5050</div>",
  "<div class='box'>you burn more calories sleeping than watching TV</div>","<div class='box'>a duck can't walk without bobbing its head</div>",
  "<div class='box'>there is no sound in space</div>","<div class='box'>DVDs are physically the same size as a CDs but can store 13 times more data</div>"
];
